require([
  ...
  var map = new Map({
    basemap: null // only feature layers
  });
  ...
  var DetailLines = new FeatureLayer({
    portalItem: {
  ...
  var btn18 = document.getElementById("zoom18");
  var btn19 = document.getElementById("zoom19");
  ...
  view.when(function () {
    ...
    if (btn19) {
      btn19.addEventListener("click", function () {
        ...
        if (btn18) btn18.classList.remove("active");
